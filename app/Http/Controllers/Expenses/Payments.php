...
class Payments extends Controller
{
    ...
    {
        if (request()->segment(2) === 'otherPayments') {
            $payments = Payment::where('other', 1)->with(['vendor', 'account', 'category'])->isNotTransfer()->collect(['paid_at'=> 'desc']);
            ...
            return view('expenses.otherPayments.index', compact('payments', 'vendors', 'categories', 'accounts', 'transfer_cat_id'));
        }
