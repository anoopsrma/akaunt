...
class Revenues extends Controller
{
    ...
    public function index()
    {
        if (request()->segment(2) === 'otherIncomes') {
            $revenues = Revenue::where('other', 1)->with(['account', 'category', 'customer'])->isNotTransfer()->collect(['paid_at'=> 'desc']);
            ...
            return view('incomes.otherIncomes.index', compact('revenues', 'customers', 'categories', 'accounts', 'transfer_cat_id'));
        }
    ...
    public function create()
    {
        ...
        if (request()->segment(2) === 'otherIncomes') {
            return view('incomes.otherIncomes.create', compact('accounts', 'currencies', 'account_currency_code', 'currency', 'customers', 'categories', 'payment_methods'));
        }
    ...
    public function store(Request $request)
    {
        ...
        if (request()->segment(2) === 'otherIncomes') {
            return redirect('incomes/otherIncomes');
        }
    }
