...
@section('title', trans('general.title.new', ['type' => trans_choice('general.otherPayments', 1)]))

@section('content')
    <!-- Default box -->
    <div class="box box-success">
        {!! Form::open(['url' => 'expenses/otherPayments', 'files' => true, 'role' => 'form', 'class' => 'form-loading-button']) !!}
        ...
        <div class="box-body">
            ...
            <input type="hidden" name="reference" value="Payments Create">
        ...
        <div class="box-footer">
            {{ Form::saveButtons('expenses/otherPayments') }}
        </div>
        <!-- /.box-footer -->
