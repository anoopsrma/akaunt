...
<div class="box box-success">
    ...
    <div class="box-body">
        ...
        <input type="hidden" name="due_at" value={{Date::now()->toDateString()}}>
        ...
        <input type="hidden" name="notes" value = "n/a">
        ...
        {{ Form::hidden('invoice_status_code', old('invoice_status_code', 'paid'), ['id' => 'invoice_status_code']) }}
