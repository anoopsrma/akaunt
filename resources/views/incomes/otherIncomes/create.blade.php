...
@section('title', trans('general.title.new', ['type' => trans_choice('general.otherIncomes', 1)]))

@section('content')
<!-- Default box -->
<div class="box box-success">
    {!! Form::open(['url' => 'incomes/otherIncomes', 'files' => true, 'role' => 'form', 'class' => 'form-loading-button']) !!}
    ...
    <div class="box-body">
        ...
        <input type="hidden" name="reference" value="Receivable Create">
    ...
    <div class="box-footer">
        {{ Form::saveButtons('incomes/otherIncomes') }}
    </div>
    <!-- /.box-footer -->
