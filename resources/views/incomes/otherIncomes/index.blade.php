...
@section('title', trans_choice('general.otherIncomes', 2))

@section('new_button')
@permission('create-incomes-revenues')
<span class="new-button"><a href="{{ url('incomes/otherIncomes/create') }}" class="btn btn-success btn-sm"><span class="fa fa-plus"></span> &nbsp;{{ trans('general.add_new') }}</a></span>
<span><a href="{{ url('common/import/otherIncomes/revenues') }}" class="btn btn-default btn-sm"><span class="fa fa-download"></span> &nbsp;{{ trans('import.import') }}</a></span>
@endpermission
<span><a href="{{ route('otherIncomes.export', request()->input()) }}" class="btn btn-default btn-sm"><span class="fa fa-upload"></span> &nbsp;{{ trans('general.export') }}</a></span>
@endsection
...
<div class="box box-success">
    <div class="box-header with-border">
        {!! Form::open(['url' => 'incomes/otherIncomes', 'role' => 'form', 'method' => 'GET']) !!}
